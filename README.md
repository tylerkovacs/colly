...
[![GoDoc](https://godoc.org/github.com/tylerkovacs/colly?status.svg)](https://pkg.go.dev/github.com/tylerkovacs/colly/v2)
...
[![view examples](https://img.shields.io/badge/learn%20by-examples-0077b3.svg?style=flat-square)](https://github.com/tylerkovacs/colly/tree/master/_examples)
...
See [examples folder](https://github.com/tylerkovacs/colly/tree/master/_examples) for more detailed examples.


## Installation

```
go get -u github.com/tylerkovacs/colly/v2/...
```


## Bugs

Bugs or suggestions? Visit the [issue tracker](https://github.com/tylerkovacs/colly/issues) or join `#colly` on freenode
...
<a href="https://github.com/tylerkovacs/colly/graphs/contributors"><img src="https://opencollective.com/colly/contributors.svg?width=890" /></a>
